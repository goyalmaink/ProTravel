...
const ThePackagesHome: React.FC = () => {
  ...
  return (
    <section className="h-[550px] flex items-center">
      <div className="container mx-auto">
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              <h2 className="w-[305px] font-oswald text-[30px] font-semibold ml-[50px] mt-[20px]">
            ...
            <button 
              ...
              className="text-white px-8 py-3 rounded-2xl transition-all duration-300 text-lg font-medium mr-[50px] mt-[20px]"
              style={{
                background: 'linear-gradient(135deg, #F36E20 0%, #FDAF16 100%)',
                fontWeight: '500'
              }}
              ...
              {visibleTrips.map((trip, index) => (
                ...
                backgroundClip: 'text'
                    ...
                    <div className="flex justify-center gap-4 items-center mt-5">
                      ...
                      className="px-[16px] py-[8px] rounded-[16px] text-white text-[18px] font-poppins font-medium transform hover:scale-105 transition-all duration-300">
                          Enquire
                      </button>
                      </div>
                  </div>
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="w-[305px] font-oswald text-[30px] font-semibold ml-[50px] mt-[80px]">
                ...
                backgroundClip: 'text'
                    ...
                    <div className="flex justify-center gap-4 items-center mt-5">
                      ...
                      <motion.button 
                        ...
                        className="px-[16px] py-[8px] rounded-[16px] text-white text-[18px] font-poppins font-medium hover:bg-[#FF6B00] transform hover:scale-105 transition-all duration-300"
                        whileHover={{ 
                          scale: 1.05,
...
export { ThePackagesHome, TrendingTips };
